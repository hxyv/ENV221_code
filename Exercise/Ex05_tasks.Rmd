...
```{r}
airquality$Month_English <- ifelse(airquality$Month == 1, "January",
                                ifelse(airquality$Month == 2, "February",
                                ifelse(airquality$Month == 3, "Match",
                                ifelse(airquality$Month == 4, "April",
                                ifelse(airquality$Month == 5, "May",
                                ifelse(airquality$Month == 6, "June",
                                ifelse(airquality$Month == 7, "July",
                                ifelse(airquality$Month == 8, "August",
                                ifelse(airquality$Month == 9, "September",
                                ifelse(airquality$Month == 10, "October",
                                ifelse(airquality$Month == 11, "November", "December")))))))))))

airquality[, c("Month", "Month_English")]
```
